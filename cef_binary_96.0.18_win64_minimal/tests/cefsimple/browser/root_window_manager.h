...
#ifndef CEF_TESTS_CEFSIMPLE_BROWSER_ROOT_WINDOW_MANAGER_H_
#define CEF_TESTS_CEFSIMPLE_BROWSER_ROOT_WINDOW_MANAGER_H_
#pragma once
...
#include "tests/cefsimple/browser/root_window.h"
