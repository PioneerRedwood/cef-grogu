...
#ifndef CEF_TESTS_CEFSIMPLE_BROWSER_ROOT_WINDOW_WIN_H_
#define CEF_TESTS_CEFSIMPLE_BROWSER_ROOT_WINDOW_WIN_H_
#pragma once
...
#include "tests/cefsimple/browser/browser_window.h"
