...
#include "tests/cefgrogu/browser/main_context_impl.h"
#include "tests/cefgrogu/browser/main_message_loop_multithreaded_win.h"
#include "tests/cefgrogu/browser/root_window_manager.h"
...
int RunMain(HINSTANCE hInstance, int nCmdShow) {
  ...
  // std::unique_ptr<client::MainContextImpl, std::default_delete<client::MainContextImpl>> context
