...
#include "tests/cefsimple/browser/root_window_win.h"
...
// #include "tests/cefclient/browser/browser_window_osr_win.h" // osr은 안씀
#include "tests/cefsimple/browser/browser_window_std_win.h"
#include "tests/cefsimple/context/main_context.h"
#include "tests/cefsimple/resource.h"

// 팝업할 때만 필요
// #include "tests/cefclient/browser/temp_window.h" // 기존에 있던 거
// #include "tests/cefclient/browser/temp_window_win.h" 
// using TempWindow TempWindowWin;
