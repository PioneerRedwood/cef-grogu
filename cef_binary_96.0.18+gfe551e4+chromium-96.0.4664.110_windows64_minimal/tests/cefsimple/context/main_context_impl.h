...
#ifndef CEF_TESTS_CEFSIMPLE_BROWSER_MAIN_CONTEXT_IMPL_H_
#define CEF_TESTS_CEFSIMPLE_BROWSER_MAIN_CONTEXT_IMPL_H_
#pragma once
...
#endif  // CEF_TESTS_CEFSIMPLE_BROWSER_MAIN_CONTEXT_IMPL_H_
