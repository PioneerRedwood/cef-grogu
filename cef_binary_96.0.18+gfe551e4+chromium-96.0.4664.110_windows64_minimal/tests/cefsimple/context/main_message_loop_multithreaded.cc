...
#include "tests/cefsimple/main_message_loop_multithreaded.h"
...
int MainMessageLoopMultithreaded::Run() {
  ...
  HACCEL hAccelTable =
      LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CEFSIMPLE));
...
// static
LRESULT CALLBACK
MainMessageLoopMultithreaded::MessageWndProc(HWND hWnd,
                                                UINT message,
                                                WPARAM wParam,
                                                LPARAM lParam) {
...
void MainMessageLoopMultithreaded::PostTaskInternal(
